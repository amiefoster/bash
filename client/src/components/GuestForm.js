    ...
    return (
        <div className="modal-form">
           <div onClick={toggleGuestForm} className="overlay"></div>
                <div className="modal-form-content" style={{backgroundColor: "#fdddf4"}}>
                   
                   <form className="new-event-form" onSubmit={handleSubmit} >
                    <div className="new-event-text-field" style={{backgroundColor: "#fdddf4"}}>
                        ...
                        <select  
                            ...
                            >
                                ...
                                {guests && guests.map(guest => <option key={guest.id} value={guest.id}>{guest.name}</option>)}
                        </select>
                        </label>
                    </div>      
                </form>                        
                    ...
                    <div style={{backgroundColor: "#fdddf4"}}>
                        <button className="new-detail-button" type="submit" onClick={handleSubmit } >Add</button>
                    </div>              
                </div>
       </div>
    )
